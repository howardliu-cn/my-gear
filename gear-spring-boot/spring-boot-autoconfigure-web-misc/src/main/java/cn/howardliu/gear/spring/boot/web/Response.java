...
public class Response<T> {
    ...
    public Response(int code, String desc, String error, String path) {
        this(code, desc, error, path, null, null);
    }

    public Response(int code, String desc, String error, String path, String bizCode, String bizDesc) {
        this.code = code;
        this.desc = desc;
        this.error = error;
        this.path = path;
